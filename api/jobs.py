...
def create_job(file_name: str, file_bytes: bytes, params: dict) -> str:
    ...
    _executor.submit(_process_job, job_id, str(input_path), job_dir, params)
    return job_id


def _process_job(job_id: str, input_path: str, job_dir: Path, params: dict):
    ...
    except (DiarizationError, TranscriptionError) as e:
